...
// Need to make dropdown button for Buttons on left turn when they are hidden on small screen
// Make navbar personalized to what we want to do vs current template defaults
// Add logo to navbar
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              <img className="h-8 w-auto" src="#" alt="Need Logo Here" />
            </div>
          ...
          <div className="flex flex-grow lg:flex-grow-0">
            <form className="flex items-center border rounded-lg overflow-hidden">
              <input type="text" className="px-4 py-2" placeholder="Search" aria-label="Search" />
              <button type="submit" className="flex items-center justify-center px-4 bg-blue-500 text-white">
                Search
              </button>
            </form>
          </div>
